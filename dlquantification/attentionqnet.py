...
from dlquantification.quantmodule.other.AttentionQ import AttentionQ


class AttentionQNet(DLQuantification):
    """
    ...
    def __init__(
        ...
        # Init the model
        quantmodule = AttentionQ(dim_in=feature_extraction_module.output_size,dim_hidden=128,num_inds=ind_points, n_bins=n_bins)
